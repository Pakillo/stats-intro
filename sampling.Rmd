...
- To read more: [Morey et al (2015)](https://learnbayes.org/papers/confidenceIntervalsFallacy/), [Rohrer 2024](https://www.the100.ci/2024/12/05/why-you-are-not-allowed-to-say-that-your-95-confidence-interval-contains-the-true-parameter-with-a-probability-of-95/)
...
- Test can detect positive COVID 90% of times (sensitivity)

- Test correctly rejects COVID 80% of times (specificity)

- Currently 1% people have COVID

- What's the probability that you have COVID?


## The probability that you have COVID is 0.06!
...
- [Matthews 2025](https://doi.org/10.1093/jrssig/qmaf044)

- [Statistics done wrong](https://www.statisticsdonewrong.com/p-value.html#the-base-rate-fallacy-in-medical-testing)
