...
Crop biomass (treatment): $10 kg \pm 2 kg$

Crop biomass (control): $6 kg \pm 2 kg$
...
Crop biomass (control): $9 kg \pm 2 kg$
...
- A p-value of 0.05 is as surprising as getting `r round(-log2(0.05), 1)` heads in a row when flipping a coin.

- A p-value of 0.01 is as surprising as getting `r round(-log2(0.01), 1)` heads in a row when flipping a coin.

- A p-value of 0.001 is as surprising as getting `r round(-log2(0.001), 1)` heads in a row when flipping a coin.

\tiny [Rafi & Greenland 2020](https://doi.org/10.1186/s12874-020-01105-9)
...
\tiny https://doi.org/10.1002/prp2.93

\normalsize Try yourself [here](https://pakillo.github.io/LM-GLM-GLMM-intro/ss_pval.html)!
...
\tiny https://www.statisticsdonewrong.com/power.html#the-wrong-turn-on-red
...
\tiny https://dx.doi.org/10.1198/000313006X152649
...
\tiny https://doi.org/10.1007/s10654-016-0149-3
...
\tiny https://dx.doi.org/10.1177/0956797613504966
...
\tiny https://doi.org/10.1242/jeb.104976
