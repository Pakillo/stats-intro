...
## Measure trunk diameter (DBH) of 30 trees in your neighbourhood
...
- Did you measure with tape, forceps, by eye?

- When did you measure: dawn, midday, night? (trees may get thinner w/ high evapotranspiration)

- Where did you measure? (differences among streets, species, etc)
...
**How well do numbers reflect what we are trying to measure?**
...
ggplot(logvec) +
  ...
  annotate("text", x = 10, y = 20, label = "Median", colour = "blue", size = 6) +
  annotate("text", x = 35, y = 20, label = "Mean", colour = "red", size = 6)
```
...
ggplot(logvec) +
  ...
  annotate("text", x = 50, y = 0.03, label = "Percentile 75", colour = "red", hjust = 0, size = 6) +
  annotate("text", x = 50, y = 0.025, label = "75% of data to the left\n25% to the right", 
...
Facilitates comparing the spread of distributions with very different means
